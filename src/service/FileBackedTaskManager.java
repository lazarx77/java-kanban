    ...
    public String toString(Task task) {
        ...
        if (task.toString().startsWith("Task")) {
            result = id + "," + TaskType.TASK + "," + task.getTaskName(id) + "," + task.getStatus() + "," +
                    task.getDescription() + "," + task.getStartTime().format(Task.formatter) + "," + task.getDuration().toMinutes();
            ...
            result = id + "," + TaskType.SUBTASK + "," + task.getTaskName(id) + "," + task.getStatus() + "," +
                    ...
                    task.getStartTime().format(Task.formatter) + "," + task.getDuration().toMinutes();
        }
        return result;
    }
    ...
    public Task fromString(String string) {
        ...
        switch (TaskType.valueOf(split[1])) {
            case EPIC:
                ...
                epic.setStartTime(LocalDateTime.parse(split[5], epic.formatter));
            ...
            case SUBTASK:
                ...
                subtask.setStartTime(LocalDateTime.parse(split[6], subtask.formatter));
